...
function ProdukList() {
  ...
  const updateProduk = async () => {
    try {
      const { kodeBarang, gambar, created_at, updated_at, ...dataToUpdate } =
        editForm;
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
          ...
          {filteredProduk.map((produk) => (
            ...
            >
              ...
              <div className="h-48 bg-gray-200 relative">
                ...
                {produk.gambar ? (
                  <img
                    src={`http://127.0.0.1:8000/storage/${produk.gambar}`}
        ...
        {selectedProduk && (
          <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4">
            ...
            <div className="bg-white rounded-3xl max-w-4xl w-full max-h-[90vh] overflow-auto p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  {selectedProduk.gambar && (
                    <img
                      src={`http://127.0.0.1:8000/storage/${selectedProduk.gambar}`}
